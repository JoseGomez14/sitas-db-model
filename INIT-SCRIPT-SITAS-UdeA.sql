...
CREATE TABLE Luggage(
  LUGGAGE_ID NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY,
  ...
  LUGGAGE_TYPE_ID REFERENCES LuggageType NOT NULL
);

CREATE TABLE LuggageType(
  LUGGAGE_TYPE_ID NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY,
